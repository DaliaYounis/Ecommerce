    ...
    <div class="container">
        ...
        <div class="checkout-section">
            <div>
                <form action="{{route('checkout.store')}}" method="POST"id="payment-form">
                   {{csrf_field()}}
                    ...
                    <button type="submit" id="order-complete" class="button-primary full-width">Complete Order</button>
            ...
            <div class="checkout-table-container">
                ...
                <a href="#" style="margin-bottom: 30px;" class="have-code" >Have a Code?</a>
...
@section('extra-js')
    ...
    var submitButton = document.getElementById('order-complete');
